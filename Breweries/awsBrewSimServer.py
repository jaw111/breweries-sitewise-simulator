...
logging.basicConfig(format='%(levelname)s: %(message)s', level=logging.INFO) # use filename parameter to log to a file
...
if __name__ == "__main__":
    ...
    def publish_to_sitewise_thread():
        ...
        logging.info("Publishing values to SiteWise")
        while True:
            #######################################################################
    ...
    server.start()
    logging.info("Started OPC server")
    ...
    try:
        ...
        server.stop()
        logging.info("Stopped OPC server")
